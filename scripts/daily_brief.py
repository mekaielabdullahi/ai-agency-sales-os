...
connected sources, synthesizing with Claude, and delivering to Telegram.
...
Usage:
    ...
    python scripts/daily_brief.py --preset solo       # Use solo preset
...
def run_daily_brief(target_date=None, preset="solo", dry_run=False,
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        help="Report preset (default: from .env or solo)",
    )
    ...
    preset = args.preset or os.environ.get("BRIEF_PRESET", "solo")
