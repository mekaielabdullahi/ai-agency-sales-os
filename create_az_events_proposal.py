...
run.font.size = Pt(11)
run.font.color.rgb = RGBColor(0x5B, 0x9B, 0xD5)
run = prep.add_run("Amy, AZ Inflatable Events")
run.bold = True
run.font.size = Pt(14)
...
# Interview table for AZ Inflatable Events
interview_table = doc.add_table(rows=4, cols=3)
...
phases = [
    ...
    ("Phase 3\nQuick Wins", "Staff training framework, event operations checklists, initial SOPs documented — tangible value delivered during the assessment."),
...
# Save
output_path = "c:/Users/MEKAIEL/Downloads/AZ_Inflatable_Events_AI_Opportunity_Assessment.docx"
