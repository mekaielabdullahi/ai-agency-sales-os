...
| New Lead Notification | Webhook (call/client create) | SMS/Email to Kelsey | ☐ |
...
| **Output** | Email to Alyssa (optionally Kelsey) |
...
| **Output** | SMS/Email to Kelsey instantly |
...
| Kelsey reviewing daily digest | Daily habit formed |
...
| Kelsey doesn't adopt template | Keep to 5 fields max, demo time savings |
