...
- ✅ "You're spending 15 hours/week on bookkeeping that could be automated" (IF they said 15 hours)
...
**Connect to business outcomes (ONLY with verified data):**
- ✅ "Automating lead follow-up could recover lost opportunities" (general)
- ✅ "You mentioned losing 20-30 leads/month - automating follow-up addresses this" (if they said it)
- ❌ "Automating lead follow-up could recover 20-30 lost leads/month ($10K+ revenue)" (fabricated numbers)

---

## ⚠️ CRITICAL: Data Integrity Rules

**NEVER fabricate, estimate, or invent:**
- Dollar amounts (revenue, costs, losses, savings)
- Time estimates (hours/week, time saved)
- Percentages (conversion rates, efficiency gains, ROI)
- Counts (leads, customers, deals, contacts)
- Any specific metrics not explicitly stated by the client

**If information was NOT provided:**
1. Use `"UNKNOWN - needs follow-up"` or `null` in JSON fields
2. Add item to discovery-unknowns.md for follow-up
3. State clearly: "Client did not provide [X] - to be gathered in follow-up"
4. DO NOT estimate or make up placeholder values

**Acceptable vs. Unacceptable:**
- ✅ "estimated_hours_per_week": null (if not discussed)
- ❌ "estimated_hours_per_week": 10 (made up)
- ✅ "No CRM causing lost sales from missed follow-ups" (qualitative, stated)
- ❌ "No CRM causing $5,500/week in lost revenue" (quantitative, fabricated)
- ✅ "David mentioned follow-ups are based on memory"
- ❌ "30-40% of opportunities lost to forgotten follow-ups"

**When in doubt:**
- Leave blank or mark as UNKNOWN
- Add to unknowns list for follow-up
- Never guess or extrapolate numbers
- Qualitative observations are acceptable; quantitative fabrications are not
...
- [ ] Hours per week are ONLY included if explicitly stated by client (otherwise null)
...
- [ ] **NO fabricated numbers** - all metrics came directly from client
- [ ] **All unknowns documented** - missing data added to discovery-unknowns.md
- [ ] **Every dollar/percentage/time figure is sourced** from transcript or marked UNKNOWN
